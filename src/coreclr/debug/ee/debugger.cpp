...
HRESULT Debugger::MapPatchToDJI(DebuggerControllerPatch *dcp, DebuggerJitInfo *djiTo)
{
    ...
    LOG((LF_CORDB, LL_EVERYTHING, "D::MPTDJI Begin %p, patchId:0x%x\n", dcp, dcp->patchId));
...
void Debugger::LockAndSendEnCRemapCompleteEvent(MethodDesc *pMD)
{
    ...
    LOG((LF_CORDB, LL_INFO10000, "D::LASEnCRE: %s::%s dmod:0x%x, methodDef:0x%x \n",
                                  ...
                                  SIZE_T enCVersion)
{
    ...
    LOG((LF_CORDB, LL_INFO10000, "D::SEnCUE: type: %u module: %p tkMember: %x tkType: %x, ver: %zu\n",
