...
class DebuggerController
{
  ...
  public:
    ...
    static void DispatchPreStubPatch(PCODE addr);
...
public:
    ...
    void EnablePreStubPatch();
    void DisablePreStubPatch();
  ...
  protected:
    ...
    virtual void TriggerPreStubPatch(PCODE target);
...
protected:
    ...
    void TriggerPreStubPatch(PCODE target);
